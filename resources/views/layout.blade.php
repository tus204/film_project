...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/logo_poly.png') }}" type="image/x-icon" />
    <meta name="revisit-after" content="1 days" />
    <meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
    <title>Web phim đen của bố Tú</title>
    <meta name="description" content="Web phim đen của bố Tú" />
    <link rel="canonical" href="">
    <link rel="next" href="" />
    <meta property="og:locale" content="vi_VN" />
    <meta property="og:title" content="Web phim đen của bố Tú" />
    <meta property="og:description" content="Web phim đen của bố Tú" />
    ...
    <style>#header .site-title {background: url('{{ asset('images/logo_poly.png') }}') no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
</head>
<body class="home blog halimthemes halimmovies" data-masonry="">
    ...
    <script type='text/javascript' src='{{ asset('js/bootstrap.min.js?ver=5.7.2') }}' id='carousel-js'></script>
    <script type='text/javascript' src='{{ asset('js/bootstrap.min.js?ver=5.7.2') }}' id='halim-init-js'></script>
