...
<div class="row container" id="wrapper">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span>Phim thuộc năm » <span class="breadcrumb_last" aria-current="page"><a href="{{ url('year/' . $year) }}">{{ $year }}</a></span></span></span></div>
            </div>
        </div>
    </div>
